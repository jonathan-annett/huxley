...
// EMU-16 differential-harness hooks. Empty unless overridden via -D.
#ifndef HARNESS_STEP_BEGIN
#define HARNESS_STEP_BEGIN() ((void)0)
#endif
#ifndef HARNESS_STEP_END
#define HARNESS_STEP_END() ((void)0)
#endif
